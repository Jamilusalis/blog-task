    ...
    <div class="row no-gutters">      
      <div class="col-md-8">
        <div class="card-body">
          <h6>
            ...
            xmlns="http://www.w3.org/2000/svg"> <path fill-rule="evenodd" d="M3 1a1 1 0 0 0-1 1v4.586a1 1 0 0 0 .293.707l7 7a1 1 0 0 0 1.414 0l4.586-4.586a1 1 0 0 0 0-1.414l-7-7A1 1 0 0 0 7.586 1H3zm4 3.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z"/> <path d="M1 7.086a1 1 0 0 0 .293.707L8.75 15.25l-.043.043a1 1 0 0 1-1.414 0l-7-7A1 1 0 0 1 0 7.586V3a1 1 0 0 1 1-1v5.086z"/>
            </svg> CategoryName
            </span>
          </h6>

          <h5 class="card-title text-capitalize">Blog title here </h5>
          <hr/>
          <p class="card-text">
            <!--Posted by -->
              <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-person-lines-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg"> <path fill-rule="evenodd" d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm7 1.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5zm-2-3a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm0-3a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm2 9a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5z"/> </svg> userName
            ...
            <small class="card-text text-muted">
              Last updated on Sep 6th, 2020 13:20:01
            </small>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="card-body">
          <div class="card">
            <div class="card-body">
              <button type="button" class="btn btn-outline-secondary btn-sm btn-block" onclick="window.location.href='index.php';">
              ...
              <button type="button" class="btn btn-outline-success btn-sm btn-block" onclick="window.location.href='add.php';">
              ...
              <button type="button" class="btn btn-outline-info btn-sm btn-block" onclick="window.location.href='edit.php';">
              ...
              <button type="button" class="btn btn-outline-danger btn-sm btn-block" data-toggle="modal" data-target="#confirmAction" data-whatever="@mdo">
